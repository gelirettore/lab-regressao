...
def MlpRegr():
	...
	(test1) = Test(model1, y1_train,  y1_test, 'mlp-test1')
	(test2) = Test(model2, y2_train,  y2_test, 'mlp-test2')
...
def DTRegr():
	...
	debug("testing...")
	(test1) = Test(model1, y1_train,  y1_test, 'dt-test1')
	(test2) = Test(model2, y2_train,  y2_test, 'dt-test2')
...
def RandForestRegr():
	...
	(test1) = Test(model1, y1_train, y1_test, 'rf-test1')
	(test2) = Test(model2, y2_train, y2_test, 'rf-test2')
...
def GradBoostRegr():
	...
	(test1) = Test(model1, y1_train, y1_test, 'gb-test1')
	(test2) = Test(model2, y2_train, y2_test, 'gb-test2')
